      ...
      <div className="flex flex-1 flex-row justify-start" onClick={() => {}}>
        <Link href="/">
          <div className="flexCenter md:hidden cursor-pointer">
            <Image src={images.logo02} objectFit="contain" width={75} height={75} alt="logo" />
            <p className="dark:text-white text-nft-black-1 font-semibold text-lg ml-1">Ultraverse</p>
          </div>

        </Link>
        <Link href="/">
          <div className="hidden md:flex" onClick={() => {}}>
            <Image src={images.logo02} objectFit="contain" width={100} height={100} />
          </div>
        </Link>
      </div>
